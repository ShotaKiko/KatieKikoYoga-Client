        ...
        <div className="classDescription">
          ...
          <div className="optionsButtons">
            <Button size="small" color="primary">
              <a href="https://paypal.me/katiekikoyoga?locale.x=en_US">
                Sign Up
              </a>
            </Button>
            {/* <Button size="small" color="primary">
      ...
      <div className="thirdRow">
        <div className="classDescription">
          ...
          <Typography variant="body1" component="p">
            ...
            practice. Once you’ve got down the basics, anyone is welcome to try
            an Advanced Yoga Class!
          </Typography>
        ...
        {/* <img src={advancedPose} alt="advanced yoga pose" /> */}
      </div>
